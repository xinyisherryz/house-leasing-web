...
public class ConnectionManager {
	...
	private final String user = "root";   // change user and password
	// Password for the user.
	private final String password = "Zxy951028";  // change user and password
	...
	private final String schema = "houseSystem";
